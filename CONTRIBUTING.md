...
First off, thank you for considering contributing to ICEbot! It's people like you that make this package better for everyone.
...
- [Ask a question](https://github.com/maiHydrogen/ICEbot/issues)
- [Submit a bug report](https://github.com/maiHydrogen/ICEbot/issues)
- [Request a new feature](https://github.com/maiHydrogen/ICEbot/issues/new/choose)
- [Suggest ways to improve the developer experience of an existing feature](https://github.com/maiHydrogen/ICEbot/issues/new/choose)
- Add documentation
...
You can find all existing issues [here](https://github.com/maiHydrogen/ICEbot/issues). 
...
**Step 3** - Fork the [`maiHydrogen/ICEBot`](https://github.com/maiHydrogen/ICEbot) repo to your account.  
...
**Step 1** - Open an [issue](https://github.com/maiHydrogen/ICEbot/issues/new/choose) so that we can discuss on the new feature.  
**Step 2** - Fork the [`maiHydrogen/ICEbot`](https://github.com/maiHydrogen/ICEbot) repo to your account.  
